      ...
      <!-- Small boxes (Stat box) -->
        <section class="col-lg-12 connectedSortable">
            ...
            <div class="card formView">
                ...
                <form class="postform" method="post" action="/upload_media" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="card-footer">
                        ...
                        <button type="submit" class="btn submitbtn btn-success col-lg-3">Upload media</button>
